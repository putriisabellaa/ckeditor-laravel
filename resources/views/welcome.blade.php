...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('vendor/sample/styles.css')}}">
</head>
<body data-editor="DecoupledEditor" data-collaboration="false" data-revision-history="false">
		...
		{{-- <button id="sumbit">Save</button> --}}
		<script src="{{asset('vendor/build/ckeditor.js')}}"></script>
		<script src="{{asset('vendor/sample/script.js')}}"></script>
	</body>
</html>